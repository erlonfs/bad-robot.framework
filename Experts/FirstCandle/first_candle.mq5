...
#property description   "Utiliza o setup rompimento do primeiro candle de 1 Hora.O programa exibi marcações em tela durante as analises. Em marcações de cor vermelha (padrão), o mesmo espera uma entrada em venda descoberta, em marcações de cor azul (cor pre-definida) o programa espera uma entrada em compra.\n\n\nBons trades!\n\nEquipe BAD ROBOT.\nerlon.efs@gmail.com"
